...
class System_Snapshot_Report
{
	...
	public function scripts_styles( $hook ) {
		...
		// Bail if not on the snapshot page.
		if ( 'tools_page_snapshot-report' !== $hook ) {
			return;
		}
	...
	public function snapshot_report() {
		...
		<h1><?php _e( 'System Snapshot Report ' . SSRP_VER, 'system-snapshot-report' ) ?></h1>
